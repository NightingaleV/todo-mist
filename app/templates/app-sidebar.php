<aside class="sidebar d-none d-sm-block col-7 col-sm-3">
  <div class="top-filter">
    <ul class="top-filter-list">
      <li class="top-filter-item"><a href=""><span class="top-filter-label">Inbox</span></a> </li>
      <li class="top-filter-item"><a href=""><span class="top-filter-label">Today</span></a> </li>
      <li class="top-filter-item"><a href=""><span class="top-filter-label">Next 7 days</span></a> </li>
    </ul>
  </div>
  <div class="projects">
