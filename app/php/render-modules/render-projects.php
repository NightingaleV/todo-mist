...
if(isset($_SESSION['id'])){
  ...
  $stmt = $db->prepare("SELECT projects.project, projects.project_position FROM projects WHERE projects.user_id = ? AND NOT project = 'Inbox' ORDER BY project_position ASC");
